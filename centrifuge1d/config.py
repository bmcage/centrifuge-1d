...
class ModulesManager():
    def __init__(self):
        available_modules = listdir(os.path.dirname(os.path.abspath(__file__))
                + os.sep + 'modules')
        ...
        for module_name in available_modules:
            ...
            try:
                ...
                importlib.import_module(submodule_info_name, 'centrifuge1d')

                submodule_info = sysmodules['centrifuge1d' + submodule_info_name]
    ...
    def find_module(self, modname_or_exptype, submodule='', not_found=None):
        ...
        if not module_name in self._loaded_modules:
            ...
            importlib.import_module(module_full_name, 'centrifuge1d')

            module = sysmodules['centrifuge1d' + module_full_name]
...
def load_model(experiment_info, display_only=False, validate=True,
    ...
    if display_only:
        header = ("Configuration file of experiment '{}' "
                  "number {}".format(experiment_info['exp_id'],
