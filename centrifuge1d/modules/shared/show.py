...
FIGURES_DEFAULTS = \
              {'h':  {'title':  'Hydraulic head',
               ...
               'WM': {'title':  'Water mass balance',
                      ...
                      'xtype':  'time',
                      'ytype':  'length'},
               'WM_in_tube':  {'title':  'Water mass in the sample in the tube',
                               'xlabel': dg_label_time,
                               'ylabel': "Water mass in sample [{}]",
                               'xtype':  'time',
                               'ytype':  'length'},
               ...
               'e':  {'title':  'Void ratio',
                      ...
                      'legend_bbox': (1.01, 1.),
                      'legend_loc': 2},
               'e_avg':  {'title':  'Average Void ratio',
                      'xlabel': dg_label_time,
                      'ylabel': "Average Void ratio $e$ [{}]",
                      'xtype':  'time',
                      'ytype':  'none',},
